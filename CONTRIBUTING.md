...
project. Please create a Github issue in that project. All dependencies should
be open source software and can be found on Github.

Submit a ticket for your issue, assuming one does not already exist:
  - Create it on the projects [issue Tracker][issues].
...
standards set by the projects styleguide.
...
[issues]: https://github.com/godaddy/swagger-jsdoc-deref/issues
